...
$mpdf=new mPDF('en-x','A4','','',15,5,20,47,-1,1); 
//$mpdf=new mPDF('en-x','A4','font-size','',margin-left,margin-right,margin-content-top,margin-content-bottom,margin-header,margin-footer); 
